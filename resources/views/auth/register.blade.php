                        ...
                        <div class="panel-body">
                            ...
                            <form class="ma-4" role="form" method="POST" action="{{ route('register') }}">
                                ...
                                <div class="form-group{{ $errors->has('zip') ? ' has-error' : '' }}">
                                    ...
                                    <div>
                                        <input id="zip" type="text" class="form-control" name="zip" value="{{ old('first_name') }}" required>
                                ...
                                <div class="form-group{{ $errors->has('material_status') ? ' has-error' : '' }}">
                                    ...
                                    <div class="">
                                        <select id="material_status" name="material_status" class="form-control" required>
                                ...
                                <div class="form-group{{ $errors->has('liquidity_importance') ? ' has-error' : '' }}">
                                    ...
                                    <div class="">
                                        <select id="liquidity_importance" name="liquidity_importance" class="form-control" required>
                                ...
                                <div class="form-group{{ $errors->has('net_worth') ? ' has-error' : '' }}">
                                    ...
                                    <div class="">
                                        <select id="net_worth" name="net_worth" class="form-control" required>
                                ...
                                <div class="form-group{{ $errors->has('yearly_income') ? ' has-error' : '' }}">
                                    ...
                                    <div class="">
                                        <select id="yearly_income" name="yearly_income" class="form-control" required>
                                            <option value="Under $25000">Under $25000</option>
                                ...
                                <div class="form-group{{ $errors->has('liquid_assets') ? ' has-error' : '' }}">
                                    ...
                                    <div class="">
                                        <select id="liquid_assets" name="liquid_assets" class="form-control" required>
                                            <option value="Under $25000">Under $25000</option>
                                            <option value="$25000-$50000">$25000-$50000</option>
                                            <option value="$50000-$65000">$50000-$65000</option>
                                            <option value="$65000-$100000">$65000-$100000</option>
