...
// dd($states);
    ...
    public function register(Request $request)
    {
        ...
        // create customer in sliced.app
        // DB::connection('mysql2')->insert('insert into tblclients (company, vat, phonenumber, country, city, zip, state, address, website, datecreated, active, leadid, billing_street, billing_city, billing_state, billing_zip, shipping_country, longitude, latitude, default_language, default_currency, show_primary_contact, stripe_id, registration_confirmed, added_from) values (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)', [null, null, $request->phone, 0, null, null, null, null, null, null, 1, null, null, null, null, null, 0, null, null, null, null, 0, null, null, null, 0, 0, null, 1, 0]);
    ...
    protected function create(array $data)
    {
       ...
       // header("locationh: http://sliced.money/one.php?name='fahad'");
        ...
        &city={$data['city']}&employment={$data['employment']}&material_status={$data['material_status']}&dependents={$data['dependents']}&goal={$data['goal']}
