...
class CampaignsController extends Controller
{
    ...
    public function create()
    {
        ...
        $previous_states = State::orderBy('state_name', 'asc')->get();
        $previous_cities = City::orderBy('city_name', 'asc')->get();

        return view('admin.start_campaign', compact('title', 'categories', 'countries', 'previous_states', 'previous_cities', 'distances'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('admin.edit_campaign', compact('title', 'categories', 'countries', 'campaign', 'previous_states', 'previous_cities'));
    }
    ...
    public function update(Request $request, $id){
        ...
        $update = Campaign::find($id)->update($data);
